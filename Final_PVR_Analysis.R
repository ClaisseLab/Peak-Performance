...
#### Module Cluster Analysis Fig S2 ----
wide_fish_ht_mod_18 <- wide_fish_ht_mod_18 %>% 
...
#### Submodule Cluster Analysis Fig 2B ----
...
#### Figure 2: Combined nMDS, cluster, module diagram plot ------------------------
...
#### Community Composition Stacked Bar Plots Fig 4 ----
