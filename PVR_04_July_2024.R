...
library(cowplot) # for making combined figure
...
## !!! REVISED Legend scale to end at 200 (w/ densities /2)
...
# 
# rotate6 <- c(2, 11,  3, 10, 20,  6, 24, 23,  7,18,  4,  5, 12, 16, 19, 14,  1, 15, 22,  8, 13, 17, 21,  9)
# dend_rotated6 <- rotate(dend_rotated, rotate6)
# plot(dend_rotated6)
# # order.dendrogram(dend_rotated6)
...
# Save the plot
ggsave("figures/submodule_dendrogram_clusters.png", plot_gg_os_ht_dend,
       width = 18, height = 7.5, dpi = 600)
...
## Combined nMDS, cluster, diagram plot ------------------------
...
plot_wide_fish_os_ht2 <- ggplot(wide_fish_os_ht, aes(-MDS1, -MDS2)) +
  ...
  # geom_text(data = spp_scrs, aes(x = (-NMDS1 * .38)-0.05,
  #                                y = -NMDS2 * .38, 
  #                                label = common_name, shape = NULL), 
  #           fontface = "bold", 
  #           color = "black", 
  #           size = 4) +
  geom_text_repel(
...
ggsave("figures/combined_nMDS_dendro_figure.png", combined_plot, width = 7, height = 9, units = "in", dpi = 600)
